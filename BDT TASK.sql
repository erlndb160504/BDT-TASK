...
-- Dumping data for table bdt task.data mahasiswa: ~10 rows (approximately)
/*!40000 ALTER TABLE `data mahasiswa` DISABLE KEYS */;
INSERT INTO `data mahasiswa` (`NIM`, `Nama`, `Alamat`, `E-mail`) VALUES
	('\n225150300111006', ' Moudy Lestari Tulus Widodo', ' Jl. Raya Kepuharjo', 'mou@student.ub.ac.id			'),
	('\n225150300111011', ' Sherina Yosephine Angelica', ' Kerto Asri Dalam', ' sherina@student.ub.ac.id		'),
	('\n225150301111004', ' Maulana Muhammad Ali', ' Jl. Benduingan Sigura-gura Barat', ' ali@student.ub.ac.id			'),
	('\n225150301111005', ' Kurnita Ruci', ' Jl. Kalpataru', ' ruci@student.ub.ac.id			'),
	('\n225150301111007', ' Erlinda Butarbutar', ' Jl. Sigura-gura II', ' erlinda@student.ub.ac.id			'),
	('\n225150307111003', ' Audrey Zakiya Trustee', ' Jl. Watugong', ' audrey@student.ub.ac.id			'),
	('\n225150307111006', ' Ziyyan Dehani Safti Ajly', ' Jl. Sigura-gura VI', ' ziyyan@student.ub.ac.id			'),
	('\n225150307111008', ' Rizky Akbar', ' Jl. Kertosari', ' kybar@student.ub.ac.id			'),
	('\n225150307111013', ' Ivan Rafli Adipratama', ' Jl. Jombang', ' ivan@student.ub.ac.id			'),
	('\n225150307111014', ' Adinni Salsabillah', ' Jl. Sigura-gura I', ' salsa@student.ub.ac.id			');
